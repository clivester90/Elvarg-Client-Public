...
import com.runescape.draw.RasterProvider;
...
public abstract class GameEngine extends Applet implements Runnable, WindowListener, FocusListener {
    ...
    public final void resizeCanvas() {
        ...
        if (container != null) {
            ...
            Client.rasterProvider = new RasterProvider(canvasWidth, canvasHeight, canvas);
            if (container == frame) {
    ...
    final synchronized void addCanvas() {
        ...
        if (Client.rasterProvider != null && canvasWidth == Client.rasterProvider.width && canvasHeight == Client.rasterProvider.height) {
            ((RasterProvider) Client.rasterProvider).setComponent(canvas);
